...
| --- | --- | --- | --- | --- |
| Repo-local specs | OpenAPI, Swagger, GraphQL, AsyncAPI, Postman, protobuf, Smithy | Full for OpenAPI 3.x; partial for Swagger and native API formats | `runbooks/repo-spec.md` | `evidence/README.md` |
...
| API Gateway REST | AWS OpenAPI export | Full OpenAPI 3.0 YAML | `runbooks/api-gateway.md` | `evidence/README.md` |
...
| SNS contracts | AsyncAPI / JSON Schema plus sidecars | Partial OpenAPI 3.1 and webhook OpenAPI 3.1 sidecar | `runbooks/sns.md` | `evidence/README.md` |
| Lambda Function URL | Synthesized URL contract | Full OpenAPI 3.0 YAML | `runbooks/lambda-url.md` | `evidence/README.md` |
| IaC/repo signals | Provider hints and contract/schema files | Partial OpenAPI from discovered AsyncAPI/GraphQL artifacts | `runbooks/iac-repo-signals.md` | `evidence/README.md` |
