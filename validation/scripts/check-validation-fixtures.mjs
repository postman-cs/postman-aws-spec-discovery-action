...
const required = [
  ...
  'validation/fixtures/repo-spec/introspection.json',
  'validation/fixtures/repo-spec/service.wsdl',
  'validation/fixtures/repo-spec/mcp.json',
...
const markerChecks = [
  ...
  ['validation/fixtures/repo-spec/introspection.json', '"__schema"'],
  ['validation/fixtures/repo-spec/service.wsdl', 'schemas.xmlsoap.org/wsdl'],
  ['validation/fixtures/repo-spec/mcp.json', 'mcpServers'],
